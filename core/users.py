...
SECRET = "your-secret-key"  # В продакшене использовать безопасный секретный ключ
...
class UserManager(BaseUserManager[User, int]):
    ...
    async def create(self, user_create: UserCreate, safe: bool = False, request: Optional[dict] = None) -> User:
